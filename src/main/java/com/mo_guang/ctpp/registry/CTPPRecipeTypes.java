...
public class CTPPRecipeTypes {
    ...
    public static final GTRecipeType KINETIC_MIXER_RECIPES = REGISTRATE.recipeType(CTPP.id("kinetic_mixer"), KINETIC)
            ...
            .setMaxTooltips(4);
    public static final GTRecipeType SMASHING_FACTORY_RECIPES = REGISTRATE
            .recipeType(CTPP.id("smashing_factory_recipes"), KINETIC)
            .cnlang("粉碎工厂")
            ...
            .setSound(GTSoundEntries.MIXER)
            .setMaxTooltips(4);
    public static final GTRecipeType KINETIC_GENERATOR_RECIPES = REGISTRATE
            .recipeType(CTPP.id("kinetic_generator"), KINETIC)
            .cnlang("应力发电")
            .setMaxIOSize(0, 0, 1, 0)
            .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW_MULTIPLE, LEFT_TO_RIGHT)
            .setSound(GTSoundEntries.ARC)
            .setMaxTooltips(4);
    public static final GTRecipeType KINETIC_STEAM_TURBINE_RECIPES = REGISTRATE
            .recipeType(CTPP.id("kinetic_steam_turbine"), KINETIC)
            .cnlang("蒸汽动力")
    ...
    public static final GTRecipeType WINDMILL_CONTROL = REGISTRATE
            .recipeType(CTPP.id("windmill_control_center"), ELECTRIC)
            .cnlang("风车控制中心")
            .setMaxIOSize(0, 0, 1, 0)
            .setSlotOverlay(false, false, GuiTextures.SOLIDIFIER_OVERLAY)
    ...
    public static void init() {
        ...
        // MainConfig.INSTANCE.gtmConfig.kineticCreateMixerSpeedMultiplier), 1))
        // .buildRawRecipe();
        // new CTPPRecipeBuilder(newrecipe,
        // KINETIC_MIXER_RECIPES).rpm(MainConfig.INSTANCE.gtmConfig.kineticCreateMixerRPMRequirement)
        // .save(provider);
        // }
        // });
