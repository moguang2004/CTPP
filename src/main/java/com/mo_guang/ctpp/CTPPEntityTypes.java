...
public class CTPPEntityTypes {
    ...
    // 这是控制结构的实体,从ct抄的
    public static final EntityEntry<SimpleRotatingContraptionEntity> SIMPLE_CONTRAPTION = contraption(
            "simple_contraption",
            SimpleRotatingContraptionEntity::new, () -> (SimpleContraptionEntityRenderer::new), 10, 3, true)
            .visual(() -> ContraptionVisual::new)
            .register();
    public static final EntityEntry<RubiksCubeContraptionEntity> RUBIKS_CUBE_CONTRAPTION = contraption(
            "rubiks_cube_contraption",
            RubiksCubeContraptionEntity::new, () -> (SimpleContraptionEntityRenderer::new), 10, 3, true)
            .visual(() -> ContraptionVisual::new)
            .register();

    private static <
            T extends Entity> CreateEntityBuilder<T, ?> contraption(String name, EntityType.EntityFactory<T> factory,
    ...
    private static <
            T extends Entity> CreateEntityBuilder<T, ?> register(String name, EntityType.EntityFactory<T> factory,
                                                                 NonNullSupplier<NonNullFunction<EntityRendererProvider.Context, EntityRenderer<? super T>>> renderer,
