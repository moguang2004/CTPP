...
public class FactoryStaticBlockPattern {
     ...
     */
    public FactoryStaticBlockPattern aisleRepeatable(int minRepeat, int maxRepeat, String... aisle) {
     ...
     */
    public FactoryStaticBlockPattern aisle(String... aisle) {
     ...
     */
    public FactoryStaticBlockPattern setRepeatable(int minRepeat, int maxRepeat) {
        if (minRepeat > maxRepeat)
            throw new IllegalArgumentException("Lower bound of repeat counting must smaller than upper bound!");
     ...
     * Set last aisle repeatable
     */
    public FactoryStaticBlockPattern setRepeatable(int repeatCount) {
        return setRepeatable(repeatCount, repeatCount);
    }

    public static FactoryStaticBlockPattern start() {
        return new FactoryStaticBlockPattern(RelativeDirection.LEFT, RelativeDirection.UP, RelativeDirection.FRONT);
    }
    ...
    public StaticBlockPattern build() {
