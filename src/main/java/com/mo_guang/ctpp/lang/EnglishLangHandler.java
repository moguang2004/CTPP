...
public class EnglishLangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("ctpp.multiblock.kinetic_workable_multiblock_machine.reduction",
                "Status: Recipe time reduction x0.75");
        provider.add("ctpp.multiblock.kinetic_workable_multiblock_machine.overclock", "Status: Overclocked");
        provider.add("ctpp.multiblock.kinetic_workable_multiblock_machine.perfect_overclock",
                "Status: Lossless overclocked");
        ...
        provider.add("ctpp.multiblock.kinetic_steam_turbine.tooltip.2",
                "Steam-type machines lose 10% efficiency for each voltage tier above §6HV§r");
        provider.add("ctpp.multiblock.kinetic_steam_turbine.tooltip.3",
                "Running efficiency will gain an addition of (1 + tier/(tier + 1))");

        provider.add("ctpp.multiblock.windmill_control_center.tooltip.0",
                "Windmill Master Control! The more, the stronger!");
        ...
        provider.add("ctpp.multiblock.windmill_control_center.tooltip.2",
        ...
        provider.add("ctpp.multiblock.boom_of_create.tooltip.1",
        ...
        provider.add("ctpp.multiblock.boom_of_create.tooltip.2",
        ...
        provider.add(MainConfig.getConfigOptionKey("kineticInputBoxTorqueMultiplier"),
                "Kinetic Input Box Torque Multiplier");
        provider.add(MainConfig.getConfigOptionKey("kineticOutputBoxTorqueMultiplier"),
                "Kinetic Output Box Torque Multiplier");
        provider.add(MainConfig.getConfigOptionKey("enableGTMKineticCreateMixer"), "Enable GTM Kinetic Mixer");
        provider.add(MainConfig.getConfigOptionKey("kineticCreateMixerSpeedMultiplier"),
                "Kinetic Mixer Speed Multiplier Compared to Mixer");
        provider.add(MainConfig.getConfigOptionKey("kineticCreateMixerRPMRequirement"),
                "Kinetic Mixer RPM Requirement");
        ...
        provider.add(MainConfig.getConfigOptionKey("smashingFactoryMaximumProcessingCapacity"),
                "Smashing Factory's Max Capacity (Integer for Voltage Tier)");
        provider.add(MainConfig.getConfigOptionKey("smashingFactorySpeedMultiplier"),
                "Smashing Factory Speed Multiplier Compared to Maceration");
        provider.add(MainConfig.getConfigOptionKey("smashingFactoryRPMRequirement"),
                "Smashing Factory RPM Requirement");
        provider.add(MainConfig.getConfigOptionKey("smashingFactoryStressRequirement"),
                "Smashing Factory Stress Load Factor (Recipe's Voltage × This Value)");

        provider.add(MainConfig.getConfigOptionKey("enableKineticGenerator"), "Enable Kinetic Generator");
        provider.add(MainConfig.getConfigOptionKey("kineticGeneratorGeneratingBoost"),
                "Kinetic Generator's EU Generation Boost");
        provider.add(MainConfig.getConfigOptionKey("kineticGeneratorGeneratingRequireLubricant"),
        ...
        provider.add(MainConfig.getConfigOptionKey("steamPoweredKineticGeneratingBoost"),
                "Steam Turbine Stress Output Boost");
